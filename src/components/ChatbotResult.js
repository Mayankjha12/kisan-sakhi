...
function ChatbotResult() {
    ...
    // **IMPORTANT:** Replace these strings with the ACTUAL personalized output 
    // you generated from your Colab Notebook for a convincing demo.
    ...
    return (
        <div id="chatbot-results" className="mt-12 p-8 bg-gray-100 text-gray-800 rounded-xl shadow-2xl border-t-4 border-green-600">
